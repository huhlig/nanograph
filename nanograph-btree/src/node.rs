...
impl BPlusTreeNode {
    ...
    pub fn new_leaf(id: BTreeNodeId) -> Self {
    ...
    pub fn new_internal(id: BTreeNodeId) -> Self {
    ...
    pub fn parent(&self) -> Option<BTreeNodeId> {
        match self {
    ...
    pub fn set_parent(&mut self, parent: Option<BTreeNodeId>) {
        match self {
    ...
    pub fn get_child_for_key(&self, key: &[u8]) -> Option<BTreeNodeId> {
        match self {
    ...
    pub fn insert_internal_entry(&mut self, key: Vec<u8>, child: BTreeNodeId) {
    ...
    pub fn get_all_children(&self) -> Vec<BTreeNodeId> {
        match self {
...
impl InternalNode {
    ...
    pub fn insert_key_child(&mut self, key: Vec<u8>, child: BTreeNodeId) {
...
mod tests {
    ...
    #[test]
    fn test_node_id() {
        let id = BTreeNodeId::new(42);
        assert_eq!(id.as_u64(), 42);
    }

    #[test]
    fn test_internal_node_find_child() {
        let mut node = InternalNode::new(BTreeNodeId::new(1));
    ...
    fn test_leaf_node_insert() {
        let mut node = LeafNode::new(BTreeNodeId::new(1));
